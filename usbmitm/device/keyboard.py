...
KeyboardInterface = Interface(descriptors=[Endpoint(1,INT,IN,8,24),HIDDescriptor()],cls=HID,subcls=1,proto=1)
...
class Keyboard(HIDDevice):
    ...
    def __init__(self,args):
        ...
        ident.set_strings(["\x09\x04","USBiquitous emulated keyboard".encode('utf-16le'),"USBIQUITOUS".encode('utf-16le')])
