...
def proxy():
    ...
    assert not proxy.usbq_has_device_packet()
    assert not proxy.usbq_has_host_packet()
    return proxy
...
def test_send_recv(proxy):
    ...
    while not proxy.usbq_has_device_packet():
        pass
    ...
    while not proxy.usbq_has_host_packet():
        pass
