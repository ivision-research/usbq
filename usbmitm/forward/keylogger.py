...
class Keylogger(Forwarder):
    ...
    def create_arg_subparser(cls,parser):
        parser.add_argument("--no-release",action="store_true",help="Do not output release keys")
        parser.add_argument("--no-interpret",action="store_true",help="Do not interpret key")
        parser.add_argument("--output","-o",metavar="FILE",help="Store all scan code to files")
